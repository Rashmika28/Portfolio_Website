...
import photo from '../assets/picture1.jpeg'
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-screen-xl mx-auto px-2 sm:px-4 md:px-8 lg:px-16">
        ...
        <div className="mt-10 md:mt-0 md:w-1/2 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-7xl font-bold mb-4">
            I'm <span className="text-[#1e293b] dark:text-white">Rashmika </span>
            <span className="text-[#2563eb] dark:text-indigo-400">Thattapally</span>
          </h1>
          <div className="flex items-center justify-center md:justify-start mb-6">
            ...
            <span className="text-xl md:text-2xl font-semibold text-[#2563eb] dark:text-indigo-400">
              <Typewriter
                words={['Web Development', 'Data Analyst', 'Software Developer','Prompt Engineering']}
                loop={0}
                cursor
                cursorStyle="_"
                typeSpeed={70}
