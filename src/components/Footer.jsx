  ...
  return (
    <footer className="bg-[#050331] text-white py-10 px-6 sm:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-gray-700 pb-8">
        {/* Portfolio Info */}
        <div>
          <h2 className="text-2xl font-semibold mb-4">Rashmika's Portfolio</h2>
        ...
        <div>
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-center gap-2">
              <FaPhoneAlt className="text-yellow-400" /> +91 9014065600
            </li>
            <li className="flex items-center gap-2">
              <FaEnvelope className="text-yellow-400" /> rashmikarashu28@gmail.com
            </li>
            <li className="flex items-center gap-2">
              <FaMapMarkerAlt className="text-yellow-400" /> Nizamabad, India
            </li>
          </ul>
          ...
          <div className="flex gap-4 mt-4">
            {[
              { icon: <FaLinkedin className="w-5 h-5" />, url: 'https://www.linkedin.com/in/rashmika-thattapally-91076825a', label: 'LinkedIn' },
              { icon: <FaGithub className="w-5 h-5" />, url: 'https://github.com/Rashmika28/', label: 'GitHub' },
      ...
      <div className="text-center text-gray-400 mt-6">
        ...
        <span className="text-yellow-400 font-semibold">Rashmika</span>
      </div>
    </footer>
  )
}
